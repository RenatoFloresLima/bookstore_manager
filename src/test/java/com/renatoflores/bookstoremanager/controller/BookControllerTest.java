...
import com.renatoflores.bookstoremanager.utils.BookUtils;
...
import static com.renatoflores.bookstoremanager.utils.BookUtils.*;
...
public class BookControllerTest {
    ...
    void testWhenPOSTwithInvalidISBNIsCalledThenBadRequestShouldBeReturned() throws Exception {
        BookDTO bookDTO = createFakeBookDTO();
        bookDTO.setIsbn("invalid isbn nfsijdnfodsnfods nfoikds nfodsn fodsn fodsnfdos fniods nfoids fnoids fnoisd fndoiw fnoids fniods nfoids nfoids nfoidsjnfoids nfoid foidsn foids njfoidsn fiods nfiods nfiosd nfoids nfoids foids nfoipds nfoipdsnfoids nfoids nfoids nfoids nfoipds nfoipsn foisdnfoidsnfoidsnfoidsnfoi");
